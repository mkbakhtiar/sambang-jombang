                ...
                <div class="sidebar" style="height: 200vh;">
                    <ul class="list-unstyled ps-0">
                        <li class="mb-1">
                            ...
                            <div class="collapse" id="inflasi-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataHarga">Harga</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="collapse" id="inflasi-collapse">
                        ...
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#stunting-collapse" aria-expanded="false">
                                <!-- <img src="assets/front/img/inflasi.png" alt="" class="icon"> -->
                                Penanganan Stunting
                            </button>
                            <div class="collapse" id="stunting-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataBalita">Data
                                            Balita Stunting</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#bumd-collapse" aria-expanded="false">
                                <!-- <img src="assets/front/img/inflasi.png" alt="" class="icon"> -->
                                BUMD
                            </button>
                            <div class="collapse" id="bumd-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataBUMD">Data
                                            BUMD</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#layananpublik-collapse"
                                aria-expanded="false">
                                <!-- <img src="assets/front/img/layanan_publik.png" alt="" class="icon"> -->
                                Layanan Publik
                            </button>
                            <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataSD">Data Sekolah
                                            SD dan SMP</a></li>
                                </ul>
                            </div>
                            <!-- <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataSMP">Data Sekolah
                            ...
                            <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail"
                                            data-id="dataPuskesmasBaru">Data Puskesmas</a></li>
                                </ul>
                            </div>
                            <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataRS">Data Rumah
                                            Sakit</a></li>
                                </ul>
                            </div>
                            <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataFaskes">Data
                                            Fasilitas Kesehatan Lainnya</a></li>
                                </ul>
                            </div>
                            <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataRSUDPloso">Data
                                            RSUD Ploso</a></li>
                                </ul>
                            </div>
                            <div class="collapse" id="layananpublik-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataRSUDJombang">Data
                                            RSUD
                                            Jombang</a></li>
                                </ul>
                            </div>
                        ...
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#pengangguran-collapse" aria-expanded="false">
                                <!-- <img src="assets/front/img/layanan_publik.png" alt="" class="icon"> -->
                                Pengangguran
                            </button>
                            <div class="collapse" id="pengangguran-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataPengangguran">Data
                                            Pengangguran</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#kemiskinan-collapse" aria-expanded="false">
                                <!-- <img src="assets/front/img/layanan_publik.png" alt="" class="icon"> -->
                                Kemiskinan
                            </button>
                            <div class="collapse" id="kemiskinan-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataKemiskinan">Data
                                            Kemiskinan</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#anggaran-collapse" aria-expanded="false">
                                <!-- <img src="assets/front/img/layanan_publik.png" alt="" class="icon"> -->
                                Penyerapan Anggaran
                            </button>
                            <div class="collapse" id="anggaran-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataPenyerapan">Data
                                            Penyerapan Anggaran</a></li>
                                </ul>
                            </div>
                        </li>
                        <li class="mb-1">
                            <button class="btn btn-toggle align-items-center text-start rounded collapsed"
                                data-bs-toggle="collapse" data-bs-target="#perijinan-collapse" aria-expanded="false">
                                <!-- <img src="assets/front/img/layanan_publik.png" alt="" class="icon"> -->
                                Perijinan
                            </button>
                            <div class="collapse" id="perijinan-collapse">
                                <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small ul-list">
                                    <li><a href="#" class="link-dark rounded btn-detail" data-id="dataPerizinan">Data
                                            Perijinan</a></li>
                                </ul>
                            </div>
                        </li>
