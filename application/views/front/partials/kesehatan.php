        ...
        <div class="row gy-4">
            <div class="col-md-3" style="display: flex; flex-direction: column; align-items: center;">
                <div class="d-flex flex-column align-items-center">
                    <button id="button1" class="btn button-2" onclick="showDiv(1)">
                        <div id="slide"></div>
                        <a href="#">Rumah Sakit Daerah Umum Jombang</a>
                    </button>
                    <button id="button2" class="btn button-2" onclick="showDiv(2)">
                        <div id="slide"></div>
                        <a href="#">Puskesmas</a>
                    </button>
                </div>
            ...
            <div class="col-md-8" id="rsud" style="display: block; flex-direction: column;">
            <h2>Rumah Sakit Umum Daerah Jombang</h2>
                <p>Sumber Data: <a href="https://rsudjombang.jombangkab.go.id/" target="_blank">https://rsudjombang.jombangkab.go.id/</a></p>
               
            <?php
                $grouped_tempattidur = array();
                foreach ($props['list_tempattidur'] as $tempattidur) {
                    $nama_ruangan = $tempattidur['nama_ruangan'];
                    if (!isset($grouped_tempattidur[$nama_ruangan])) {
                        $grouped_tempattidur[$nama_ruangan] = array();
                    }
                    $grouped_tempattidur[$nama_ruangan][] = $tempattidur;
                }
            ?>
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-md-8 text-start">
                    <?php setlocale(LC_TIME, 'id_ID');?>
                    <h5>Update terakhir: <?php echo strftime('%e %B %Y, %H:%M', strtotime($props['rsud_updated_at'])); ?></h5>
                </div>
                <div class="col-md-4 text-end">
                <button class="btn btn-primary" id="refreshRSUD">
                        <span id="refreshRSUDText">REFRESH</span>
                        <span id="loadingRSUD" style="display: none;">
                ...
                <div class="carousel-inner">
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Grafik Ketersediaan Tempat Tidur</h4>
                            </div>
                                <!-- <div class="card-body"> -->
                                <div class="card-body" style="height: 600px; max-height: 600px; overflow-y: auto;">
                                    <div id="chart"></div>
                                </div>
                    </div>
                    </div>
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Detail Ketersediaan Tempat Tidur</h4>
                            </div>
                                <div class="card-body" style="height: 600px; max-height: 600px; overflow-y: auto;">
                            
                                <?php foreach ($grouped_tempattidur as $nama_ruangan => $tempattidurs): ?>
                                    <h4><?php echo $nama_ruangan; ?></h4>
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    <th>Nama Tempat Rawat</th>
                                                    <th>Kapasitas</th>
                                                    <th>Kosong</th>
                                                    <th>Terisi</th>
                                                </tr>
                                            ...
                                            <tbody>
                                                <?php foreach ($tempattidurs as $tempattidur): ?>
                                                    <tr>
                                                        <td><?php echo $tempattidur['nama_tempat_rawat']; ?></td>
                                                        <td><?php echo $tempattidur['kapasitas']; ?></td>
                                                        <td><?php echo $tempattidur['kosong']; ?></td>
                                                        <td><?php echo $tempattidur['terisi']; ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
            ...
            <div class="col-md-8" id="puskesmas" style="display: none; flex-direction: column; align-items: center;">
                <h2>Puskesmas</h2>
                <p>Sumber Data: <a href="https://simpus.jombangkab.go.id/" target="_blank">https://simpus.jombangkab.go.id/</a></p>
                <div class="row d-flex align-items-center justify-content-between">
                <div class="col-md-8 text-start">
                    <?php setlocale(LC_TIME, 'id_ID');?>
                    <h5>Update terakhir: <?php echo strftime('%e %B %Y, %H:%M', strtotime($props['simpus_updated_at'])); ?></h5>
                </div>
                <div class="col-md-4 text-end">
                ...
                <div class="d-flex justify-content-center">
                    <div class="row">
                        <div class="box">
                            ...
                            <p>Grafik ini menunjukkan distribusi total kunjungan pasien puskesmas berdasarkan kelompok umur.</p>
...
<style>
  ...
  /* CSS */
    .btn {
        width: 60%; /* Lebar tombol 90% dari lebar layar */
        margin-bottom: 10px; /* Ruang antara tombol */
    }

    iframe {
        width: 90vw; /* Lebar iframe 90% dari viewport width */
        height: 80vh; /* Tinggi iframe 50% dari viewport height */
    }

    /* Media queries untuk keperluan tertentu jika diperlukan */
    @media screen and (max-width: 768px) {
        .btn {
            width: 70%; /* Ubah lebar tombol menjadi 100% untuk layar kecil */
        }
        iframe {
            width: 100vw; /* Lebar iframe 100% dari viewport width untuk layar kecil */
            height: 60vh; /* Tinggi iframe 60% dari viewport height untuk layar kecil */
        }
    }
</style>
...
<style>
        ...
        .carousel-control-prev {
            left: -50px; /* Adjust this value to position the button further to the left */
        }

        .carousel-control-next {
            right: -50px; /* Adjust this value to position the button further to the right */
        }
    </style>
    <script>
