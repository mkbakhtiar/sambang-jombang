...
<script>
    var dt_table = $('#tb_data').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: base_url + 'geoportal/views/get_data',
            type: 'POST'
        },
        scrollX: true,
        drawCallback: function() {
            $('.btn-detail').on('click', function(e) {
                ...
                detaildiv.html('');
                modal.modal('show');
                $.post(base_url + 'geoportal/views/get_detail', {
                        id: id,
                    })
                    .done(function(data) {
            ...
            $('.btn-edit').on('click', function(e) {
                ...
                $.post(base_url + 'geoportal/views/edit', {
                        id: id,
                        act: 'edit'
                    })
                    .done(function(data) {
            ...
            $('.check-status').on('click', function(e) {
                // e.preventDefault();
                var id = $(this).data('id');
                $.post(base_url + 'geoportal/views/upstate', {
                    id: id
                }).done(function(data) {
            ...
            $('.btn-delete').on('click', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.post(base_url + 'geoportal/views/delete', {
                            id: id
                        }).done(function(data) {
                            if (data.status == 'success') {
                                $('#tb_data').DataTable().ajax.reload(null, false);
