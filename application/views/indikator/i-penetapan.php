        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <?php if ($this->session->admin || $this->session->admin2): ?>
                    <div class="row mb-4">
                        <div class="col-12">
                            <select class="form-control select2" name="pilih-skpd" id="pilih-skpd" style="width: 100%;"
                                required>
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <div class="alert alert-danger text-center" role="alert">
                                    <a href="<?= base_url('indikator/transfer'); ?>">Terdapat <?= $props['transfer_count'] ?>
                                        Permintaan Pemindahan Kewenangan Data Ke OPD Lain</a>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="col-lg-4">
                        <div class="card border border-primary">
                            <div class="card-header bg-primary">
                                <h5 class="my-0 text-light"><i class="mdi mdi-bullseye-arrow me-3"></i>Jumlah Indikator
                                </h5>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card border border-warning">
                            <div class="card-header bg-warning">
                                <h5 class="my-0 text-light"><i class="mdi mdi-bullseye-arrow me-3"></i>Terkonfirmasi
                                </h5>
                            </div>
                            <div class="card-body text-center">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-center d-none" id="download-container">
                                    <a href="<?= base_url('download/berita_acara/' . (($props['id_skpd'] != null) ? $props['id_skpd'] : '')) ?>"
                                        class="btn btn-sm btn-primary waves-effect waves-light">
                                        <i class="bx bx-download font-size-16 align-middle me-2"></i> Download Berita
                                        Acara
                                    </a>
                                </div>
                            </div><!-- end card-body -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end justify-content-end">
                                        <div class="d-grid gap-1 d-md-flex justify-content-md-end">
                                            <?php if ($this->session->admin || !$this->session->admin2): ?>
                                                <a href="<?= base_url('indikator/add') ?>"
                                                    class="btn btn-primary waves-effect waves-light align-middle">
                                                    <i class="bx bxs-plus-square font-size-16 align-middle me-2"></i> Tambah
                                                </a>
                                            <?php endif; ?>
                                            <!-- Add this inside the main content area, after the "Tambah" button -->
                                            <?php if ($this->session->admin || !$this->session->admin2): ?>
                                                <div class="dropdown d-inline-block">
                                                    <button class="btn btn-warning dropdown-toggle" type="button" id="importDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                        <i class="bx bx-import font-size-16 align-middle me-2"></i> Import
                                                    </button>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                        href="<?= base_url('download/download/penetapan/excel/' . ($this->session->admin || $this->session->admin2 ? $this->uri->segment(3) : null)) ?>">Excel</a>
                                                    <a class="dropdown-item"
                                                        href="<?= base_url('download/download/penetapanAll/excel/' . ($this->session->admin || $this->session->admin2 ? $this->uri->segment(3) : null)) ?>">Excel
                                                        All</a>
